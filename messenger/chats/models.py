...
class Account(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('main page', kwargs = {'account_id' : self.id})
...
class Chat(models.Model):
    ...
    is_private = models.ForeignKey('PrivateChat', null=True, default=None, on_delete=models.SET_NULL,
...
class Message(models.Model):
    ...
    user = models.ForeignKey(Account, on_delete=models.SET_NULL, null=True, related_name='messagefromuser')
...
class Participants(models.Model):
    ...
    user = models.ForeignKey(Account, on_delete=models.SET_NULL, related_name='users', null=True)
